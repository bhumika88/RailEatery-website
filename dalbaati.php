...
if(isset($_POST['submit'])){
	...
	<?php
		echo '<script type="text/javascript"> window.open("dalbaatipup.php","_self");</script>';
 ...
 <span class = "slash">|<img src = "images/trainicon.png" width = "15px" height = "15px" hspace = "7px"> </span><a href = "poptrain.php"> Popular Trains </a>
		...
		<div id = "abt1">
			...
			<div>
					...
					<input type = "button" value = "BACK" id = "orderbutton" onclick = "window.open('kota.php','_self');"> 
			</div>
