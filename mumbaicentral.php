...
<div id = "bar">
 ...
 <span class = "slash">|<img src = "images/trainicon.png" width = "15px" height = "15px" hspace = "7px"> </span><a href = "poptrain.php"> Popular Trains </a>
	...
	<div id = "MAIN">
		<div id = "RestrauntHeading"> <h3> Restaurants in Mumbai Central </h3>
		</div>
		...
		<div id = "abt1">
			...
			<div class = "resinfo">
				...
				<span id = "resname">Purohit Thali</span> <br><br>
				<span> <img src = "images/locationicon.png" width = "20px" height = "20px" hspace = "7px"> Near station </span>
				 <br>
				<span> <img src = "images/cheficon.jpg" width = "20px" height = "20px" hspace = "7px">   Punjabi, Gujarati  </span>
			...
			<div id = "view">
				...
				<input type = "hidden" value = "Purohit Thali" name = "restaurantname">
		...
		<div class = "resinfo">
				...
				<span> <img src = "images/locationicon.png" width = "20px" height = "20px" hspace = "7px">  Mumbai Central </span>
				<br>
				<span> <img src = "images/cheficon.jpg" width = "20px" height = "20px" hspace = "7px"> Punjabi, Chinese   </span>
				<span> <img src = "images/vegetarianicon.png" width = "15px" height = "25px" > </span>
				<span> <img src = "images/swaminarayan.png" width = "15px" height = "25px" > </span>
				<span> <img src = "images/jain.png" width = "15px" height = "25px"  > </span>
			...
			<div id = "view">
				...
				<form method = "POST" action = "selectrestaurant1.php">
				<input type = "hidden" value = "Hotel Oyster" name = "restaurantname">
				 <input type = "submit" value = "View Menu" name = "View Menu" id = "orderbutton"> </span> <br>
				</form>
			</div>
		</div>
