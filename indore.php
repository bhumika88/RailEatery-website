...
<div id = "bar">
 ...
 <span class = "slash">|<img src = "images/trainicon.png" width = "15px" height = "15px" hspace = "7px"> </span><a href = "poptrain.php"> Popular Trains </a>
	...
	<div id = "MAIN">
		<div id = "RestrauntHeading"> <h3> Restaurants in Indore </h3>
		</div>
		
		<div id = "abt1">
			<div class = "logores">
					<img src = "images/Basantviharlogo.jpg" width = "100px" height = "100px" >
			</div>
			<div class = "resinfo">
				
				<span id = "resname">Basant Vihar Restaurant </span> <br><br>
				
				<span> <img src = "images/locationicon.png" width = "20px" height = "20px" hspace = "7px"> M.G. Road,Indore </span>			<br>	
				<span> <img src = "images/cheficon.jpg" width = "20px" height = "20px" hspace = "7px">  Punjabi, Chinese, South Indian, Pav Bhaji </span>
				...
				<span> <img src = "images/jain.png" width = "15px" height = "25px"  > </span> <br>
			...
			<div id = "view">
				...
				<input type = "hidden" value = "Basant Vihar Restaurant" name = "restaurantname">
		...
		<div class = "resinfo">
				...
				<span> <img src = "images/locationicon.png" width = "20px" height = "20px" hspace = "7px">  Ring Road, Indore </span><br>
			...
			<div id = "view">
				...
				<form method = "POST" action = "selectrestaurant1.php">
				<input type = "hidden" value = "Sahkar Restaurant" name = "restaurantname">
				 <input type = "submit" value = "View Menu" name = "View Menu" id = "orderbutton"> </span> <br>
				</form>
