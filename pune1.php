...
<div id = "bar">
 ...
 <span class = "slash">|<img src = "images/trainicon.png" width = "15px" height = "15px" hspace = "7px"> </span><a href = "poptrain.php"> Popular Trains </a>
	...
	<div id = "MAIN">
		<div id = "RestrauntHeading"> <h3> Restaurants in Pune </h3>
		</div>
		
		<div id = "abt1">
			<div class = "logores">
					<img src = "images/dynamite_pune.jpg" width = "100px" height = "100px" >
			</div>
			<div class = "resinfo">
				
				<span id = "resname">Dynamite Lounge </span> <br><br>
				<span> <img src = "images/locationicon.png" width = "20px" height = "20px" hspace = "7px"> Old Padra Road, Pune </span>
				 <br>
			...
			<div id = "view">
				...
				<input type = "hidden" value = "Dynamite Lounge" name = "restaurantname">
		...
		<div class = "logores">
					<img src = "images/temptations_pune.jpg" width = "100px" height = "100px" >
			</div>
		<div class = "resinfo">
				
				<span id = "resname">Temptationz </span> <br><br>
				<span> <img src = "images/locationicon.png" width = "20px" height = "20px" hspace = "7px">  Old Padra Road, Pune </span>
				<br>
				<span> <img src = "images/cheficon.jpg" width = "20px" height = "20px" hspace = "7px">  Punjabi, Chinese, Rajasthani, Continental </span>
				<span> <img src = "images/vegetarianicon.png" width = "15px" height = "25px" > </span>
				<span> <img src = "images/swaminarayan.png" width = "15px" height = "25px" > </span>
				<span> <img src = "images/jain.png" width = "15px" height = "25px"  > </span>
			...
			<div id = "view">
				...
				<form method = "POST" action = "selectrestaurant1.php">
				<input type = "hidden" value = "Temptationz" name = "restaurantname">
				 <input type = "submit" value = "View Menu" name = "View Menu" id = "orderbutton"> </span> <br>
				</form>
			</div>
