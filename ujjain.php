...
<div id = "bar">
 ...
 <span class = "slash">|<img src = "images/trainicon.png" width = "15px" height = "15px" hspace = "7px"> </span><a href = "poptrain.php"> Popular Trains </a>
	...
	<div id = "MAIN">
		<div id = "RestrauntHeading"> <h3> Restaurants in Ujjain </h3>
		</div>
		
		<div id = "abt1">
			<div class = "logores">
					<img src = "images/Bombay_sandwich_logo.png" width = "100px" height = "100px" >
			</div>
			<div class = "resinfo">
				
				<span id = "resname">Bombay Sandwich </span> <br><br>
				<span> <img src = "images/locationicon.png" width = "20px" height = "20px" hspace = "7px"> Paud Road, Ujjain </span>
				<br>
				<span> <img src = "images/cheficon.jpg" width = "20px" height = "20px" hspace = "7px">  Sandwiches, Thick Shakes, Juices   </span>
			...
			<div id = "view">
				...
				<input type = "hidden" value = "Bombay Sandwich" name = "restaurantname">
